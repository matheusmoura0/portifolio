document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        pt: {
            ...
            projetoTicketFlowDesc: "Sistema de venda de ingressos de alta concorrência com arquitetura escalável, locking pessimista e background jobs.",
        ...
        en: {
            ...
            projetoTicketFlowDesc: "High-concurrency ticket selling system with scalable architecture, pessimistic locking, and background jobs.",
